...
public class IRTreeMerge {
  ...
  public IRTreeMerge(Tree tree, VersionedChangeRecord changeRecord, IRNode root,
...
//
//  private Vector<String> conflictingAttributes(IRNode n){
//
//    Vector<String> attrs = new Vector<String>();
//
//    Version.saveVersion(v0);
...
//    if (n.valueExists(SimpleXmlParser.tagNameAttr) && n.valueExists(SimpleXmlParser.attrsSeqAttr)){
//      v0name = n.getSlotValue(SimpleXmlParser.tagNameAttr);
//      IRSequence<Property> v0seq = n.getSlotValue(SimpleXmlParser.attrsSeqAttr);
...
//    if (n.valueExists(SimpleXmlParser.tagNameAttr) && n.valueExists(SimpleXmlParser.attrsSeqAttr)){
//      v1name = n.getSlotValue(SimpleXmlParser.tagNameAttr);
//      IRSequence<Property> v1seq = n.getSlotValue( SimpleXmlParser.attrsSeqAttr);
...
//    if (n.valueExists(SimpleXmlParser.tagNameAttr) && n.valueExists(SimpleXmlParser.attrsSeqAttr)){
//      v2name = n.getSlotValue(SimpleXmlParser.tagNameAttr);
//      IRSequence<Property> v2seq = n.getSlotValue( SimpleXmlParser.attrsSeqAttr);
...
//  }
  ...
  private Vector<ConflictInfo> getConflictingInfos(){
    ...
    while(changes.hasNext()){
      ...
      Vector<String> conflictAttrs = conflictingAttributes2(v0,v1,v2,n);
 ...
 //     if (!SimpleXmlParser.childrenChange.changed(n, v0, v1)) continue;
      ...
      SlotInfo si = SimpleXmlParser.tagNameAttr;
...
//    if (conflictingNodes.size() > 0) return null;
  ...
  private void mergeAttributes2(IRNode n){
    ...
    if (name1 != null && name2 == null){
      n.setSlotValue(SimpleXmlParser.tagNameAttr,name1);
    }else if (name1 ==null && name2 != null){
      //nothing to do here.
    } else if (name1.equals(name2)){
    }else if (name0 != null && name1.equals(name0)){
      n.setSlotValue(SimpleXmlParser.tagNameAttr,name2);
    ...
    if (attrs2 == null) {
      n.setSlotValue(SimpleXmlParser.attrListAttr, attrs1);
      return;
    }
...
//    if (n.valueExists(SimpleXmlParser.attrsSeqAttr)){
//      v2seq = n.getSlotValue(SimpleXmlParser.attrsSeqAttr);
//    } else {
//      v2seq = VersionedSlotFactory.prototype.newSequence(-1);
//      n.setSlotValue(SimpleXmlParser.attrsSeqAttr, v2seq);
//    }
...
//  }
  ...
  private IRNode copyNode(IRNode node, Hashtable<IRNode, IRNode> removed) {
    ...
    tree.initNode(node);
    Enumeration list = SimpleXmlParser.bundle.attributes();
